...
public class MainActivity extends AppCompatActivity {
    ...
    public void onclick8(View view) {
        Toast.makeText(getApplicationContext(), "MESSAGE BEING SENT WITHOUT INTERNET", Toast.LENGTH_LONG).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("EMERGENCY LOCATION TRACKER");
...
//key board
    ...
    public void onclick5(View view) {
        ...
        startActivity(new Intent(Intent.ACTION_CALL, Uri.fromParts("tel", "1090",
                null)));
    }
